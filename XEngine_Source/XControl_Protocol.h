...
#define XENGINE_COMMUNICATION_PROTOCOL_OPERATOR_CODE_BS_REPORT 0x5011            //报告信息
#define XENGINE_COMMUNICATION_PROTOCOL_OPERATOR_CODE_BS_ENUMDEVICE 0x5012        //枚举设备
#define XENGINE_COMMUNICATION_PROTOCOL_OPERATOR_CODE_BS_RECORD 0x5013            //录屏
#define XENGINE_COMMUNICATION_PROTOCOL_OPERATOR_CODE_BS_CONNECT 0x5014           //连接
#define XENGINE_COMMUNICATION_PROTOCOL_OPERATOR_CODE_BS_SERIAL 0x50E0            //设置序列号
